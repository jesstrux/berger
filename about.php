<?php include 'includes/templates/header.php'; ?>    
    ...
    <div id="home" style="margin-top:-65px;" class="orange lighten-1 full-screen center layout-flex center-center demo section scrollspy">
        <div class="container">
            <h1 class="section-head orange-text text-lighten-5" style="margin-bottom: 0"><?php echo $site_name ?> Co.</h1>
            <p class="flow-text orange-text text-lighten-4" style="font-size: 30px; margin-bottom: 0; margin-top: 0;">
